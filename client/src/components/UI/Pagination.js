...
const Pagination = (props) => {
  ...
  useEffect(() => {
    ...
    if (currentPage > newTotalPages && newTotalPages > 0) {
      // 初次渲染 newTotalPages 會是 0，所以 currentPage 會因為大於 newTotalPages，使得 pageChangeHandler(0)，導致初次渲染沒資料，
      // 為了避免這結果，還需要再多判斷 newTotalPages 必須大於 0，否則正常渲染 pageChangeHandler(currentPage);
