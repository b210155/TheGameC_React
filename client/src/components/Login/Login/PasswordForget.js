...
const PasswordForget = (props) => {
  const [loader, setLoader] = useState(false); // Loader 等待條
  ...
  return (
    <>
      {loader ? <FullPageLoader /> : null /* 等待驗證碼 loader */}
      <Dialog onDialogClose={props.onDialogClose}>
        <form
          className={classes.passwordForgetForm}
